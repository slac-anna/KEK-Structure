//add vacuum part with density=1.0e-25g/cm3
...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    //vacuum part
    G4int numRZc = 20;
    G4double rc[] = {0*mm, 10.*mm, 10.*mm, 10.033568*mm, 10.137258*mm, 10.321539*mm, 10.611146*mm, 11.07335*mm, 12.4*mm, 41.38*mm, 41.38*mm, 12.4*mm, 11.07335*mm, 10.611146*mm, 10.321539*mm, 10.137258*mm, 10.033568*mm, 10.*mm, 10.0*mm, 0*mm} ;
    G4double zc[] = {-68.385*mm, -68.385*mm, -18.895*mm, -18.495*mm, -18.095*mm, -17.695*mm, -17.295*mm, -16.895*mm, -16.495*mm, -16.495*mm, 16.495*mm, 16.495*mm, 16.895*mm, 17.295*mm, 17.695*mm, 18.095*mm, 18.495*mm, 18.895*mm, 68.385*mm, 68.385*mm};
    G4VSolid* solidCellIn = new G4GenericPolycone("aPloycone3", 0.*deg, 360.*deg, numRZc, rc, zc);
    G4LogicalVolume *logicCellIn = new G4LogicalVolume(solidCellIn, logicMatCellIn, "logicalCellIn");
    G4VPhysicalVolume *phyCellIn = new G4PVPlacement(0, G4ThreeVector(0., 0., 0), logicCellIn, "physCellIn", logicWorld, false, 0, true);
